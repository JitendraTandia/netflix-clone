...
const Navbar = () => {
  return (
    <div className="w-[100%] px-[6%] py-[20px] flex justify-between fixed text-sm color-[#e5e5e5] z-10">
      ...
      <div className="flex items-center gap-[20px]" id="navbar-right">
        ...
        <div className="flex items-center gap-[10px] cursor-pointer relative" id="navbar-profile">
          <img className="w-[40px]" src={profile_img} alt="" />
          <img className="" src={caret_img} alt="" />
          <div className="absolute opacity-0 hover:opacity-100  text-white bg-[#191919] px-[18px] py-[22px] top-[100%] z-10 rounded-sm top right-0 w-max underline none" id="dropdown" > 
